...
(function () {
  ...
  var css = [
    '#dsh-lifecycle{position:fixed;left:12px;bottom:16px;z-index:900;display:flex;flex-direction:row;align-items:center;gap:0;min-width:0;padding:4px 6px;border-radius:18px;background:rgba(255,255,255,.93);border:1px solid rgba(0,0,0,.08);box-shadow:0 2px 12px rgba(0,0,0,.07);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.4;color:#1b1b1c;transition:opacity .3s ease}',
    '#dsh-lifecycle .lc-btn{display:inline-flex;align-items:center;justify-content:center;gap:4px;height:26px;padding:0 8px;border:none;border-radius:8px;background:transparent;color:#3c4043;font-size:12px;line-height:1;cursor:pointer;transition:background .16s ease,color .16s ease,transform .16s ease}',
    '#dsh-lifecycle .lc-sep{width:1px;height:16px;background:rgba(0,0,0,.12);margin:0 3px;flex:none}',
    ...
    '#dsh-lifecycle #dsh-quota-capsule{height:24px;padding:0 6px!important;border:none!important;border-radius:12px!important;background:transparent!important;box-shadow:none!important;cursor:pointer;transition:background .15s ease;display:inline-flex!important;align-items:center;justify-content:center;gap:4px;font-size:11px!important}',
    ...
    '#dsh-lifecycle #dsh-quota-capsule .dsh-capsule-item{font-size:11px!important;line-height:1!important;white-space:nowrap!important}',
    '#dsh-lifecycle #dsh-quota-capsule .dsh-capsule-chevron{font-size:9px!important;margin-left:-1px}',
    '#dsh-lifecycle #dsh-quota-card{position:fixed!important;left:12px!important;right:auto!important;bottom:96px!important;width:280px!important;max-width:calc(100vw - 24px)!important;margin-top:0!important;z-index:901!important}',
    ...
    '.lc-card{position:fixed;left:12px;bottom:130px;z-index:901;width:160px;max-width:calc(100vw - 24px);padding:16px;border:1px solid rgba(0,0,0,.1);border-radius:14px;background:#fff;box-shadow:0 12px 40px rgba(0,0,0,.18);font-size:14px;color:#1b1b1c;font-family:inherit;box-sizing:border-box}',
    '.lc-card-title{font-size:16px;font-weight:650;margin-bottom:8px}',
    '.lc-card-desc{color:#61666b;font-size:13px;line-height:1.6;margin-bottom:4px}',
    '.lc-card-sub{color:#868a91;font-size:12.5px;line-height:1.6;margin-bottom:16px}',
    '.lc-card-actions{display:flex;gap:8px;justify-content:flex-end}',
    '.lc-action{padding:7px 14px;border:1px solid rgba(0,0,0,.12);border-radius:8px;font-size:13.5px;line-height:1.2;cursor:pointer;background:#fff;color:#3c4043;transition:background .15s ease,color .15s ease,border-color .15s ease}',
    '.lc-action:hover{background:rgba(0,0,0,.05)}',
    ...
    '.lc-esc-hint{color:#b0b3b8;font-size:11.5px;margin-top:10px}',
    '.lc-overlay{position:fixed;inset:0;z-index:2147483000;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.72);backdrop-filter:blur(9px);-webkit-backdrop-filter:blur(9px)}',
    '.lc-overlay .lc-inner{text-align:center;max-width:520px;padding:48px;width:100%;color:#1b1b1c}',
    ...
    '.lc-sub{font-size:14px;color:#61666b;margin:0 0 6px;line-height:1.6}',
    '.lc-timer{font-size:13px;color:#b0b3b8;font-variant-numeric:tabular-nums;margin-top:22px}',
  ...
  function mount() {
    ...
    bar.style.cssText = 'position:fixed;z-index:900;display:inline-flex!important;flex-direction:row!important;align-items:center;gap:0;min-width:0;padding:4px 6px;border-radius:18px;background:rgba(255,255,255,.93);border:1px solid rgba(0,0,0,.08);box-shadow:0 2px 12px rgba(0,0,0,.07);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.4;color:#1b1b1c';
  ...
  function syncQuotaDot() {
    if (!bar || !bar.classList.contains('lc-rail')) return;
    ...
    if (parts.length) cap.title = parts.join(' · ');
    else cap.title = '模型额度';
  }
