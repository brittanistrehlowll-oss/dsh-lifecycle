...
(function () {
  ...
  var css = [
    '#dsh-lifecycle{position:fixed;left:12px;bottom:18px;z-index:900;display:flex;align-items:center;gap:0;padding:4px 6px;border-radius:18px;background:rgba(255,255,255,.92);border:1px solid rgba(0,0,0,.08);box-shadow:0 2px 10px rgba(0,0,0,.06);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.4;color:#1b1b1c;transition:opacity .3s ease}',
    ...
    '#dsh-lifecycle #dsh-quota-card{position:fixed!important;left:12px!important;right:auto!important;bottom:58px!important;width:300px!important;max-width:calc(100vw - 24px)!important;margin-top:0!important;z-index:901!important}',
    ...
    '#dsh-lifecycle .lc-card{position:fixed;left:12px;bottom:62px;z-index:901;width:280px;max-width:calc(100vw - 24px);padding:16px;border:1px solid rgba(0,0,0,.1);border-radius:14px;background:#fff;box-shadow:0 12px 40px rgba(0,0,0,.18);font-size:14px;color:#1b1b1c;font-family:inherit;box-sizing:border-box}',
