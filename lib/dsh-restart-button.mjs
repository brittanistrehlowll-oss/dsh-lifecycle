...
(function () {
  ...
  var css = [
    ...
    '#dsh-lifecycle #dsh-quota-card{position:fixed!important;left:12px!important;right:auto!important;bottom:52px!important;width:280px!important;max-width:calc(100vw - 24px)!important;margin-top:0!important;z-index:901!important}',
  ...
  function applyGeometry() {
    ...
    if (rail) {
      ...
      bar.style.bottom = (window.innerHeight - s.bottom + 14) + 'px';
    } else {
