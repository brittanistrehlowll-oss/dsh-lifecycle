...
(function () {
  ...
  var css = [
    '#dsh-lifecycle{position:fixed;left:12px;bottom:60px;z-index:900;display:flex;align-items:center;gap:0;padding:4px 6px;border-radius:18px;background:rgba(255,255,255,.92);border:1px solid rgba(0,0,0,.08);box-shadow:0 2px 10px rgba(0,0,0,.06);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.4;color:#1b1b1c;transition:opacity .3s ease}',
    '#dsh-lifecycle .lc-btn{display:inline-flex;align-items:center;justify-content:center;gap:4px;height:28px;padding:0 10px;border:none;border-radius:8px;background:transparent;color:#3c4043;font-size:12px;line-height:1;cursor:pointer;transition:background .16s ease,color .16s ease,transform .16s ease}',
    '#dsh-lifecycle .lc-sep{width:1px;height:18px;background:rgba(0,0,0,.1);margin:0 5px;flex:none}',
    ...
    '#dsh-lifecycle #dsh-quota-capsule{height:26px;padding:0 10px!important;border:none!important;border-radius:13px!important;background:transparent!important;box-shadow:none!important;cursor:pointer;transition:background .15s ease}',
    '#dsh-lifecycle #dsh-quota-capsule:hover{background:rgba(0,0,0,.05)!important}',
    '#dsh-lifecycle #dsh-quota-card{position:fixed!important;left:12px!important;right:auto!important;bottom:104px!important;width:300px!important;max-width:calc(100vw - 24px)!important;margin-top:0!important;z-index:901!important}',
    ...
    '#dsh-lifecycle .lc-card{position:fixed;left:12px;bottom:108px;z-index:901;width:280px;max-width:calc(100vw - 24px);padding:16px;border:1px solid rgba(0,0,0,.1);border-radius:14px;background:#fff;box-shadow:0 12px 40px rgba(0,0,0,.18);font-size:14px;color:#1b1b1c;font-family:inherit;box-sizing:border-box}',
